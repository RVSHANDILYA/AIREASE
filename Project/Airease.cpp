...
#include<dos.h>
#include<fstream.h>
char l_destination[5][20]={"HYDERABAD","KOLKATA","BANGLORE","NEW DELHI","MUMBAI"};
  char i_destination[10][20]={"LONDON","BERLIN","DUBAI","NEW YORK","CALIFORNIA","PARIS","CANBERRA","TOKYO","LOS ANGELES","SAN FRANCISCO" };
class mytime
{
protected:
 int choose;
public:
 ...
 void show()
 {
  ...
  {
    cout<<"|                                                                         "<<endl;
    cout<<"|flight mytime 1 PM                                                        "<<endl;
    cout<<"|_________________________________________________________________________"<<endl;
    cout<<"                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
    ofstream outfile;
    outfile.open("TICKET.txt",ios::app);
    outfile<<"|                                                                         "<<endl<<
	     "|flight mytime 1 PM                                                        "<<endl<<
	"|_________________________________________________________________________"<<endl<<
       "                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
  }
  if(choose==3)
  {
    cout<<"|                                                                         "<<endl;
    cout<<"|flight mytime 7 PM                                                        "<<endl;
cout<<"|_________________________________________________________________________"<<endl;
    cout<<"                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
    ofstream outfile;
    outfile.open("TICKET.txt",ios::app);
    outfile<<"|                                                                         "<<endl<<
	     "|flight mytime 7 PM                                                        "<<endl<<
	"|_________________________________________________________________________"<<endl<<
       "                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
  }
 }
...
void getdata(void);
 ...
 void local::getdata()
 {
  ...
  case 1:
   if (option==1)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO SPICE JET AIRLINES"<<endl;
   break;
  case 2:
   if(option==2)
...
ofstream outfile;
 ...
 void getdata(void);
  ...
  cout<<"2)EMRAITES"<<endl;
  cout<<"3)ETIHAD"<<endl;
  cout<<"4)LUFTHANSA"<<endl;
  cout<<"enter your choice"<<endl;;
  cin>>option;
  clrscr();
  switch(option)
  ...
  case 2:
   if(option==2)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO EMRAITES"<<endl;
   break;
  case 3:
   if(option==3)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO ETIHAD"<<endl;
   break;
  case 4:
   if(option==4)
